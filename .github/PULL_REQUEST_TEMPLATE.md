...
<!-- Describe the user-visible behaviour, safety guarantee, docs, or setup change. -->
...
- [ ] No secrets, credentials, local personal paths, audit logs, or generated install artefacts are
      committed.

## Notes

<!-- Mention risks, follow-up work, or release considerations. -->
